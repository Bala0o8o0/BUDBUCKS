    ...
    <CardWrapper>
      ...
      <CardContent>
        <Grid
          ...
          mt={3}
        >
          <Typography variant="body1" color="white" >TVL</Typography>
          <Typography variant="h5" color="#00ff4a">{contractBNB} MATIC</Typography>
        </Grid>
        <Grid
          container
          justifyContent="space-between"
          ...
          mt={3}
        >
          <Typography variant="body1" color="white" >Wallet</Typography>
          <Typography variant="h5" color="#00ff4a">{walletBalance.bnb} MATIC</Typography>
        </Grid>
        <Grid
          container
          justifyContent="space-between"
          ...
          mt={3}
        >
          <Typography variant="body1" color="white">Your BUDS</Typography>
          <Typography variant="h5" color="#00ff4a">{walletBalance.beans} BUDS</Typography>
        </Grid>
        {/* bnb box */}
        <Box paddingTop={4} paddingBottom={3}>
          ...
          <ButtonContainer container>
            <Grid item flexGrow={1} marginRight={0.2} marginTop={3}>
              <Button
                variant="contained"
                color="secondary"
                fullWidth
